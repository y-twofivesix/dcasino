...
DCASINO_VERSION : string                = "0.2.11";                      
DCASINO_CONTRACT_ADDRESS : string       = "secret10j4yk7jml5lalhtccwpufhjj4vu92dm7zq3hdv";     
DCASINO_CODE_ID : number                =  1655;               
CHAIN_ID : string                       = "secret-4";                     
LCD_URL : string                        = "https://lcd.mainnet.secretsaturn.net";                      
VIDEO_POKER_CONTRACT_ADDRESS : string   = "secret13svj9jpy8k6elpcrmlhytmfnhwmt8pegu73vxn"; 
VIDEO_POKER_CODE_ID: string             = "1656";          
