...
PVP_VERSION : string     = "1.0.10";              
CONTRACT_ADDRESS : string      = "secret1ew6ywn3h4mu6vmn2wlmwfrfy2dv926hxseg76j";     
CODE_ID : number               = 1431;                
CHAIN_ID : string               = "secret-4";            
LCD_URL : string               = "https://lcd.secret.express";            
